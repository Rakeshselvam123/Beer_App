...
class _DetailsPageState extends State<DetailsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255,153,51,0).withOpacity(0.4),
                  ...
                  children: <Widget>[
                            ...
                            children: <Widget>[
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  color: Color.fromARGB(255, 102, 102, 102)),
                                  child:RaisedButton(
                                    color: Color.fromARGB(255,102,34 ,0),
                                            onPressed: (){
                    ...
                    SizedBox(
                      ...
                      ListView(
                        ...
                        children: <Widget>[
                           _infoCard('Type','200', 'TIN',),
                          SizedBox(width: 10.0),
                          _infoCard('Alchol', '12 %', 'VV'),
                          SizedBox(width: 10.0),
                          _infoCard('Manufacture Date', '18-01-2020', 'Date'),
                          _infoCard('Offer Price', '10 %', 'per Tin')
                        ],
                      ),
                    ),
                    SizedBox(
